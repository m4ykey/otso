object Version {
    ...
    const val kotlinCompilerExtension = "1.5.9"
    ...
    const val composeActivity = "1.9.0-alpha03"
    const val core = "1.13.0-alpha05"
    ...
    const val kotlinAndroid = "1.9.22"
    const val application = "8.2.2"
    const val gms = "4.4.0"
